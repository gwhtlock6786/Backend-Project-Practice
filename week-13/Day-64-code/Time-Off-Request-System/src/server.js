...
const shiftSwapsRouter = require("./routes/shiftSwaps");
const laborCost = require("./routes/laborCosts");
...
app.use("/shift-swaps", shiftSwapsRouter);
app.use("/labor-cost", laborCost);
